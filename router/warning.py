...
@router.get('/community/warnings/{community_patron}/paginated/{page}/{page_size}', status_code=status.HTTP_200_OK, dependencies=[Depends(verify_user_access_token)], summary="Warnings", description="Get all community warnings by pagination")
